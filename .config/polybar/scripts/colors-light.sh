...
if  [[ $1 = "-amber" ]]; then
# Replacing colors
sed -i -e 's/bg = .*/bg = #fdf6e3/g' $PDIR/colors.ini
sed -i -e 's/fg = .*/fg = #507eaf<Right>/g' $PDIR/colors.ini
...
# Replacing colors
sed -i -e 's/bg = .*/bg = #fdf6e3/g' $PDIR/colors.ini
sed -i -e 's/fg = .*/fg = #507eaf/g' $PDIR/colors.ini
sed -i -e 's/ac = .*/ac = #507eaf/g' $PDIR/colors.ini
sed -i -e 's/bi = .*/bi = #507eaf/g' $PDIR/colors.ini
